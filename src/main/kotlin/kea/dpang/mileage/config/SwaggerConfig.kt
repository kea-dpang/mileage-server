package kea.dpang.mileage.config
 ...
 */
@OpenAPIDefinition(info = Info(title = "DPANG 마일리지 서비스 API 명세서", description = "DPANG 마일리지 서비스 API 명세서", version = "0.1.0"))
